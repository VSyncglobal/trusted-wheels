...
export default async function VehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // FIX: Explicitly type 'f' to prevent build error
  ...
  // FIX: Explicitly type 'f' to prevent build error
  const customFeatures = vehicle.features.filter((f: any) => !coreKeys.includes(f.key));
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-6 left-6 z-40">
        <Link 
            href="/inventory" 
            className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-md rounded-full border border-gray-200 text-xs font-bold uppercase tracking-widest text-black hover:bg-black hover:text-white transition-all shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 xl:col-span-4">
                <div className="sticky top-12 space-y-10">
                    ...
                    {/* 1. HEADER (No Stock Number as requested) */}
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                             <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-widest">
                                {vehicle.bodyType}
                             </span>
                        </div>
                    ...
                    {customFeatures.length > 0 && (
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {/* FIX: Explicitly type 'feat' */}
                                {customFeatures.map((feat: any) => (
                    ...
                    <div className="bg-gray-50 p-6 rounded-[2rem] border border-gray-100">
                        <InventoryActions 
                            ...
                            stockNumber={vehicle.stockNumber} // Passed invisibly
                        />
